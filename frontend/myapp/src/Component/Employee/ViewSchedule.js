...
const ViewSchedule = () => {
  ...
  return (
    <div>
      ...
      <h4 style={{ textAlign: "center", color: "black", marginTop:'20px'}} >Details of Shift Schedule</h4>
            ...
            <table className="table table-bordered border-primary">
              ...
              <tbody>
                {currentItems.map((val) => (
                  ...
                  <tr key={val._id}>
                  <td style={{ textAlign: "center" , backgroundColor:'white'}}>{val.employeeId.name}</td>
                  
                  <td style={{ textAlign: "center",backgroundColor:'white' }}>{formatDate(val.fromDate)}</td>
                  <td style={{ textAlign: "center",backgroundColor:'white' }}>{formatDate(val.toDate)}</td>
