  ...
  const handleLogin = () => {
    axios.post("http://localhost:5000/EmployeeLogin", user)
      .then(res => {
        ...
        navigate('/employeeDashboard'); // Redirect to home page upon successful login
      })
      .catch(error => {
  ...
  return (
    ...
    <div className='Employee-login-container'>
      ...
      <div className="emp-login">
        <h2 style={{marginBottom:"20px"}}><BsPeopleFill/> Employee Login</h2>
        ...
        <a style={{fontWeight:'bold', textDecoration:'none'}}href="/Email">Forget Password?</a>
        </div>
        ...
        <button type="button" onClick={handleLogin} className="btn btn-outline-primary">
