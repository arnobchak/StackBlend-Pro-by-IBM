...
const ManageEmpAccount = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/EmployeeAccount")
  ...
  return (
    <div>
      ...
      <div className='employeeTable'>
        ...
        <h4 style={{ textAlign: "center", color: "blue",marginTop:"20px"}}><BsPeopleFill/> Employee Account List</h4>
            ...
            <tbody>
              ...
              val._id === editId ? (
                <tr>
                  ...
                  <td><input class='form-control-sm w-100 p-3'type="text" value={updateEmail}  onChange={e=>setUpdateEmail(e.target.value)}></input></td>
                  <td>{val.role}</td>

                  <td>
                      <select class='form-control-sm w-100 p-3' value={updateStatus} onChange={e => setUpdateStatus(e.target.value)}>
...
export default ManageEmpAccount;
